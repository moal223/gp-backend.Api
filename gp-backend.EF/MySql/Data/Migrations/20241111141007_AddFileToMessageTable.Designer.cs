...
namespace gp_backend.EF.MySql.Data.Migrations
{
    ...
    [Migration("20241111141007_AddFileToMessageTable")]
    partial class AddFileToMessageTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("gp_backend.Core.Models.ApplicationUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a867ae25-5166-4272-8a53-521b58dd50bf",
                            Email = "admin@admin.com",
                            EmailConfirmed = true,
                            LockoutEnabled = false,
                            NormalizedEmail = "ADMIN@ADMIN.COM",
                            NormalizedUserName = "ADMIN",
                            PasswordHash = "AQAAAAIAAYagAAAAECZuLnk+0Zyc/nO+Y83M2okXyAqMcgDyw59hVfsDWKC/BjtjfH9F4/s5EQUYDk7EJA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "363a5cc7-6035-4216-abef-530737b0c52a",
                            TwoFactorEnabled = false,
                            UserName = "admin"
                        });
                });

            modelBuilder.Entity("gp_backend.Core.Models.Appointment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("gp_backend.Core.Models.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("gp_backend.Core.Models.Appointment", b =>
                {
                    b.HasOne("gp_backend.Core.Models.ApplicationUser", "Doctor")
                        .WithMany()
                        .HasForeignKey("DoctorId");

                    b.HasOne("gp_backend.Core.Models.ApplicationUser", "Patient")
                        .WithMany()
            ...
            modelBuilder.Entity("gp_backend.Core.Models.Message", b =>
                {
                    b.HasOne("gp_backend.Core.Models.FileDescription", "File")
                        .WithMany()
